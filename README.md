...
A dusk-blue base with primary leaf-green accents, cyan selections, and crisp blue/cyan separation for Windows Terminal.
...
For theme suggestions or issues, please open an issue on the [Windows Terminal theme repository](https://github.com/fjord-themes/fjord-windows-terminal/issues).